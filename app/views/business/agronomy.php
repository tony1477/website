<div class="page-header-area bg-img-news" data-bg="<?=BASE_URL?>public/assets/img/album/slider-3.jpg" style="background-position: center center;">
    <div class="container">
        <div class="row">
            <div class="col-lg-10 col-xl-8 m-auto text-center">
                <div class="page-header-content-start">
                    <div class="page-header-content" >
                        <h2><?=$this->getContent('agronomy')?></h2>
        ...
        <div class="row align-items-lg-center">
            <div class="col-md-6 col-lg-7 order-1">
                <div class="about-content ms-0">
                    ...
                    <ul>
                        <li class="fw-bold">PT. Serai Wangi Perkasa</li>
            ...
            <div class="col-md-6 col-lg-5 order-0 order-md-1">
                ...
                <figure class="service-details-thumb">
                    <img src="<?=BASE_URL?>public/assets/img/album/slider-3.jpg" alt="Businex-Service Details"/>
                    <img src="<?=BASE_URL?>public/assets/img/album/slider-7.jpg" alt="Businex-Service Details"/>
                </figure>
            </div>
        </div>
    </div>
