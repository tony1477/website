    ...
    <div class="container" style="padding-right:3.5rem">
        <div class="row mtn-40">
            ...
            <div class="counter-item">
                    <h6 class="counter-txt"><a href="<?=BASE_URL?>business/agronomy" class="text-white"><i class="mdi mdi-arrow-left-bold-circle"></i> <?=$this->getContent('prev')?> <br /><?=$this->getContent('agronomy')?></a></h6>
                </div>
            </div>
