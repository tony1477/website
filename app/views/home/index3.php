        ...
        <div class="row mtn-sm-60 mtn-md-5"> 
            <div class="col-md-6 col-lg-6">
                <div class="detail about-content" style="margin-left:0px">
                    ...
                    <h6 class="title my-3"><?=$this->getContent('home-sustain-title')?></h6>
                    <div class="sum">
                        <p><?=$this->getContent('home-sustain-content')?></p>
                    </div>
                    <div class="link pt-1">
                        <a class="btn-about" href="<?=BASE_URL?>sustainability/policy"> 
                            <?=$this->getContent('readmore')?> <span class="pl-1 icon"><i class="mdi mdi-chevron-double-right"></i></span>
                        </a>
                    </div>
                </div>
...
<?php
    $scriptfooter = '<script src="'.BASE_URL.'public/assets/js/home.js"></script>'
?>