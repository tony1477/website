...
<div class="about-area-wrapper sm-top">
    <div class="container-fluid" style="border: 0px solid #000;">
        <div class="row">
            ...
            <h2 class="text-center text-decoration-underline">Laporan Tahunan</h2>
                <div class="row justify-content-center">
                    <div class="col-3">
                        <img src="<?=BASE_URL?>public/assets/img/investor/Annual_Report_2021 copy.png" />
                        <a href="#">Laporan Tahunan 2021</a>
                    </div>
                </div>
            </div>
        </div>
