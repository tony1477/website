                ...
                <div class="col-12">
                    <div class="service-details-content">
                        <figure class="service-details-thumb">
                            <img src="<?=BASE_URL?>public/assets/img/service/details/01.jpg" alt="Businex-Service Details"/>
                            <img src="<?=BASE_URL?>public/assets/img/service/details/02.jpg" alt="Businex-Service Details"/>
                            <img src="<?=BASE_URL?>public/assets/img/service/details/03.jpg" alt="Businex-Service Details"/>
                        </figure>
                        <div class="service-details-info">
                            <h3>Serai Wangi Perkasa <code>(2019)</code></h3>
                            ...
                            <div class="pagination-wrap pb-5">
                                <ul class="pagination">
                                    <li class="next"><a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Tani Sejahtera Perkasa">Next <i class="fa fa-long-arrow-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
