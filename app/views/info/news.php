                ...
                <div class="blog-content-wrapper">
                    <div class="row mtn-30">
                        ...
                        <!-- <div class="col-md-6 col-lg-4">
                            <div class="blog-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html"><img src="<?=BASE_URL?>public/assets/img/service/01.jpg" alt="Businex-Blog"/></a>
                                </figure>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html"><img src="<?=BASE_URL?>public/assets/img/service/02.jpg"
                                                                     alt="Businex-Blog"/></a>
                                </figure>
                                <div class="blog-content">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html"><img src="<?=BASE_URL?>public/assets/img/service/03.jpg"
                                                                     alt="Businex-Blog"/></a>
                                </figure>
                                <div class="blog-content">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html"><img src="<?=BASE_URL?>public/assets/img/service/04.jpg"
                                                                     alt="Businex-Blog"/></a>
                                </figure>
                                <div class="blog-content">
                                    <h2 class="h5"><a href="blog-details.html">Master Business Plan</a></h2>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html"><img src="<?=BASE_URL?>public/assets/img/service/05.jpg"
                                                                     alt="Businex-Blog"/></a>
                                </figure>
                                <div class="blog-content">
                                    <h2 class="h5"><a href="blog-details.html">Corporate Conference 2019</a></h2>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="blog-item">
                                <figure class="blog-thumb">
                                    <a href="blog-details.html"><img src="<?=BASE_URL?>public/assets/img/service/06.jpg"
                                                                     alt="Businex-Blog"/></a>
                                </figure>
                                <div class="blog-content">
                                    <h2 class="h5"><a href="blog-details.html">New Business Strategy</a></h2>
